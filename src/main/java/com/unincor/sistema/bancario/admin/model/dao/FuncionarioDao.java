...
public class FuncionarioDao {
    ...
    public static void main(String[] args) {
        //Inserir o funcionario aqui depois...
//        Funcionario funcionario = new Funcionario(null, "AlexPFCampos", "21324654", LocalDate.now(),
//               "alexpfc@gmail.com", "4564654897", "389102312749128903");
        FuncionarioDao funcionarioDao = new FuncionarioDao();
//        var funcionarios = funcionarioDao.buscarTodosFuncionarios();
//        funcionarios.forEach(c -> System.out.println("ID: " + c.getIdFuncionario() + " Nome: " + c.getNome() + " Cpf: " + c.getCpf()
